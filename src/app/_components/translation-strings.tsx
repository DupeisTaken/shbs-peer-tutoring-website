...
export function TranslationStrings() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Keep the editing task above language administration, especially on phones. */}
      <details>
        <summary className="btn-secondary list-item min-h-11 cursor-pointer px-4 lg:min-h-9">
          {t("localization.languagesHeading")}
        </summary>
        <div className="mt-3">
          <LanguagesPanel />
        </div>
